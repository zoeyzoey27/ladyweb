...
<html lang="en">
<head>
  <title>LADY - Chỉnh sửa danh mục</title>
  <meta charset="utf-8">
         ...
         ?>  
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h2 class="h2">Chỉnh sửa danh mục sản phẩm</h2>
            ...
            <?php
                ...
                if (isset($_GET['id'])){
                  ...
                  $rowdanhmuc = executeResult($sql);
                  $row = $rowdanhmuc[0];
                }
            ?>
            <form method="POST" action="xuly.php?query=update&id=<?php echo $row['id'] ?>" style="margin: 20px 0;" enctype="multipart/form-data">
                  
                <div class="mb-3">
                  <label class="form-label">Mã danh mục</label>
                  <input type="text" name="madanhmuc"  class="form-control" value="<?php echo $row['madanhmuc'] ?> " >
                </div>
                <div class="mb-3">
                  <label class="form-label">Tên danh mục</label>
                  <input type="text" name="tendanhmuc" id="slug" class="form-control" value="<?php echo $row['tendanhmuc'] ?>" onkeyup="ChangeToSlug()" >
                </div>
                <div class="mb-3">
                  <label class="form-label">Slug</label>
                  <input type="text" name="slug" id="convert_slug" class="form-control" value="<?php echo $row['slug'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <img class="my-2" src="uploads/<?php echo $row['anhhienthi'] ?>" width="100px">
                </div>
